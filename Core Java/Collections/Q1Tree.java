...
public class Q1Tree {
	public static void main(String[] args) {
		...
		contact a2 = new contact(b, "Lady", "lady@gmail.com", Gender.female);
		contact a3 = new contact(c, "Adam", "adam@gmail.com", Gender.male);
		contact a4 = new contact(d, "Newgen", "newgen@gmail.com", Gender.male);
